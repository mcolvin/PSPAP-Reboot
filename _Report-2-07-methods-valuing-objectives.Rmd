...
If there existed a monitoring design that was clearly the most useful 
and costed the least, than a management decision would be straight 
forward.  However, maximizing a monitoring program's utility and 
minimizing its costs will often be in conflict of one another, forcing a
decision to be made given the tradeoffs in cost and utility.  Moreover,
finding a monitoring design that is "clearly the most useful" is teeming 
with issues.  First of all, what is the "most useful" is not well 
defined and likely varies from stakeholder to stakeholder.  Second of 
all, what is the "most useful" is not a stagnant concept.  Conditions change  

### Objectives hierarchy and attributes

The objectives identified by stake
holders can be valued in 
