...
data, collected following the procedures laid out from alternative 
monitoring designs, must be simulated.   

Moreover, since catchability and capture probability of particular gears 
are important elements of simulating catch data but also highly 
uncertain and in some cases unknown, it is essential that catch data is 
simulated over a wide range of plausible gear catchabilities.
