...
6. On the Fundamental objectives worksheet do the following:   (Note, these instructions are also on the worksheet.)
    1. Rank each of the scenarios (i.e., rows) using a rank of 1 as the best and 6 as the worst: 
        a. The worst case scenario is already filled in for you with a rank of 6 and a value of 0.
        b. Identify your best scenario from the remaining rows and give that a rank of 1. 
        c. Now rank the remaining scenarios, using ranks 2-5 in your order of importance. 
    2. Assign the scenario that you ranked 1 with a value of 100. 
    ...
    have a value that is greater than or equal to a scenario with a rank of 3 (but no greater than 100). *Values do not need to sum to 100.*   
