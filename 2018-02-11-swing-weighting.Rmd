...
## Instructions
1. Be sure you can open, edit, and save the swing weighting exercise (it's an excel file with 4 sheets): [Download Exercise Spreadsheet Here](swing-weighting-exercise.xlsx). 
...
3. On the Abundance worksheet do the following:  (Note, these instructions are also on the worksheet.)
    ...
    2. Rank each of the scenarios (i.e., rows). The worst case scenario is already filled in for you with a rank of 3 and a value of 0.
...
6. On the Fundamental objectives worksheet do the following:   (Note, these instructions are also on the worksheet.)
    1. Rank each of the scenarios (i.e., rows). The worst case scenario is already filled in for you with a rank of 5 and a value of 0.
    ...
    making sure that your values increase with rank. For example a scenario with a rank of 2 should
    have a higher value than a scenario with a rank of 3. *Values do not need to sum to 100.*   
3. Once you have completed filling in all 4 sheets of the swing weighting exercise, email the filled in form to: s.reynolds@msstate.edu 
