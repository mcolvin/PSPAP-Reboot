...
4. On the Trend worksheet do the following:   (Note, these instructions are also on the worksheet.)
    ...
    making sure that your values increase with rank. For example a scenario with a rank of 2 should
    have a higher value than a scenario with a rank of 3. *(Values do not need to sum to 100.)*
5. On the Recruitment worksheet do the following:   (Note, these instructions are also on the worksheet.)
    1. Rank each of the scenarios (i.e. rows). The worst case scenario is already filled in for you with a rank of 3 and a value of 0.
