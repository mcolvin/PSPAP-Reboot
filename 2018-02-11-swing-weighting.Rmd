...
this is a tedious task however, it provides a transparent and robust 
...
YouTube tutorial [Here](https://www.youtube.com/watch?v=v2nVRkpmWQY). 
...
3. On the Abundance worksheet do the following:  (Note: these instructions are also on the worksheet)
    ...
    2. Rank each of the the scenarios (i.e., rows). The worst case scenario is already filled in for you with a 3.
...
5. On the Fundamental objectives worksheet do the following:   (Note: these instructions are also on the worksheet)
    1. Rank each of the the scenarios (i.e., rows). The worst case scenario is already filled in for you with a 5.
