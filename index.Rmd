...
## Historic And Current Population Assessment Approach
...
1. Can the existing monitoring design be used in a capture-recapture context to estimate abundance
 and survival at the segment level?
## Analysis approach
...
This document is organized into 5 main sections covering major elements required
 to meet the objectives of the Pallid Sturgeon BiOp (is that right?)
For each measurable attribute approaches using marked and unmarked fish are used to evaluate
 varying sampling effort and design.  
The monitoring program is designed to build on existing PSPAP program such that new monitoring
 data will reaming comparable to legacy PSPAP data.  
 
1. Abundance
    1. Marked individuals
    1. Unmarked individuals
2. Survival
    1. Marked individuals
    1. Unmarked individuals
3. Recruitment
    1. Marked individuals
    1. Unmarked individuals
4. Abundance and demographic rates 
    1. Marked individuals
    1. Unmarked individuals
5. Other components
    1. Movement
...
<!--
link the above items abund, surv, recruit, move,.. to CEMs and pop model

Make a harder case for links to pop model and CEMs
-->
