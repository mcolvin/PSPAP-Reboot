...
```{r,echo=FALSE,as.is=TRUE,eval=FALSE}
knitr::kable(tmp,
    row.names=FALSE,
...
each common gear type. <!--SARA CAN'T COMPILE THIS TABLE...UNLESS IT IS EXACTLY THE SAME AS TABLE 4 ABOVE???  MAYBE NEED DIFFERENT effort_dat.csv.-->

```{r,echo=FALSE,eval=FALSE}
#SAME AS TABLE 4 ABOVE???
effort_summary<- read.table("_output/effort_dat.csv",sep=" ") # from table 4
kable(effort_summary, #tables_effort(4,dat=dat),
