...
until sufficient and sustained natural recruitment occurs, both of which 
are needed to achieve the fundamental objective set by the USFWS to 
preclude species jeopardy. 
...
The objective of the redesign effort is to identify sampling designs 
that will give optimal estimates given 
