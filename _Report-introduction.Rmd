...
v. 2.0 is considered a necessary part of the pallid sturgeon 
monitoring strategy, but it is not considered sufficient for 
monitoring needs. Instead, it is designed to complement three 
other components: 
...
fundamental objectives identified in the Missouri River Adaptive Management plan (hereafter AM plan) were achieved on an 
annual basis or estimated with any level of certainty. Specifically, <!-- link Wildhaber and Schaughpahg papers here-->
