...
2. Simulate the reference population for 10 years with varying but known annual
survival, growth, movement, and recruitment.

### Major Assumptions
1. Survival is homogeneous among individuals.
...
POISSON JUSTIFICATION HERE 
<!--SHOULD BE ABLE TO DERIVE THIS POISSON DISTRIBUTION WITH THE FOLLOWING ASSUMPTIONS:
...
#### Survival & Growth
Survival is homogenous with all fish in the river having an equal probability, $\phi$, of annual survival indpendent of individual age, length, sex, origin, location, and year. Annual growth is projected by individualized von Bertalanffy growth curves as 
