...
varying ways which in turn are used to calculate the expected
...
Quantify PS recruitment to age-1 (Natural origin)
    ...
    Estimate age-1 recruitment rate (natural origin)
        bias
        precision
Quantify PS population trend (natural and hatchery origin)
    Estimate RPMA level population growth rate λ
        bias
        precision
